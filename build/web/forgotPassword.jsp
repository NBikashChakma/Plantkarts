<%-- 
    ...
    Created on : May 27, 2022, 10:54:26 AM
    Author     : Bikash
--%>
...
<html>
    <head>
        ...
        <title>JSP Page Forgot Password</title>
        <link
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-10">
                        ...
                        <div class="card-body">
                            <div class="form-group">
                                <label for="email-for-pass">Enter your email address</label> <input
                                    ...
                                    email a OTP to this address.</small><br>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="login.jsp"><button class="btn btn-danger" >Back to
                                Login</button></a>
                    </div>
                </div>
            </div>
